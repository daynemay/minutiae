...
<head>
  <title>This is the user_question page</title>
  ...
  <div id="wrap">
    <div id="top">
      <div class="top align-center">
          <div>The User Question page</div>
          ${questions}
          ${dir(questions)}
    ...
    <div id="middle">
      <div class="middle align-center">
        <p class="app-welcome">
          Welcome to something something, an application generated by<br/>
          the Pyramid web application development framework.
          %for question in questions:
              <div>
                  ${question.question_text} <a href="TODO:">edit</a>  <a href="TODO:">delete</a>
              </div>
          %endfor
        </p>
        <p>
